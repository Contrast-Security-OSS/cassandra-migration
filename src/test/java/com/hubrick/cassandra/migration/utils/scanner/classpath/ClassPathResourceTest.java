 ...
 */
package com.hubrick.cassandra.migration.utils.scanner.classpath;
...
public class ClassPathResourceTest {
    ...
    public void loadAsStringUtf8WithoutBOM() {
        assertEquals("SELECT * FROM contents;",
                new ClassPathResource("com/hubrick/cassandra/migration/utils/scanner/classpath/utf8.nofilter", Thread.currentThread().getContextClassLoader()).loadAsString("UTF-8"));
    }

    @Test
    public void loadAsStringUtf8WithBOM() {
        assertEquals("SELECT * FROM contents;",
                new ClassPathResource("com/hubrick/cassandra/migration/utils/scanner/classpath/utf8bom.nofilter", Thread.currentThread().getContextClassLoader()).loadAsString("UTF-8"));
    }
}
